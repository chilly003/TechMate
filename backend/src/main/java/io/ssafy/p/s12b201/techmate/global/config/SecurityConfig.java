...
import io.ssafy.p.s12b201.techmate.global.error.exception.ExceptionFilter;
import io.ssafy.p.s12b201.techmate.global.security.JwtTokenFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((registry) ->
                        registry
                                .requestMatchers("/api/v1/credentials/test-login/**", "/api/v1/credentials/sign-up-test", "/api/v1/credentials",
                                        ...
                                        "/api/v1/credentials/oauth/valid/register", "/api/v1/credentials/login").permitAll()
