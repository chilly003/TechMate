  ...
  "node_modules/react/cjs/react-jsx-runtime.development.js"(exports) {
    ...
    (function() {
      ...
      function validateExplicitKey(element2, parentType) {
        if (element2._store && !element2._store.validated && null == element2.key && (element2._store.validated = 1, parentType = getCurrentComponentErrorInfo(parentType), !ownerHasKeyUseWarning[parentType])) {
          ownerHasKeyUseWarning[parentType] = true;
          var childOwner = "";
          element2 && null != element2._owner && element2._owner !== getOwner() && (childOwner = null, "number" === typeof element2._owner.tag ? childOwner = getComponentNameFromType(element2._owner.type) : "string" === typeof element2._owner.name && (childOwner = element2._owner.name), childOwner = " It was passed a child from " + childOwner + ".");
